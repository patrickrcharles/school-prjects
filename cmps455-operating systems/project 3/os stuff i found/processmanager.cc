...
//
//	Return index of the added UserOpenFile
//
//	"uoFile" is the UserOpenFile to be added.
//----------------------------------------------------------------------
...
//
//	Return TRUE if removed the UserOpenFile
//
//	"fileId" is the index of the UserOpenFile to be removed.
//----------------------------------------------------------------------
...
//
//	"fileId" is the index of the UserOpenFile to get.
//----------------------------------------------------------------------
